...
import AdminSeatManagement from '../views/admin/AdminSeatManagement.vue'
import AdminReservationManagement from '../views/admin/AdminReservationManagement.vue'
...
const routes = [
  ...
  { path: '/help-center', component: HelpCenter, meta: { requiresAuth: true } },
  {
    ...
    children: [
      ...
      { path: 'seats', component: AdminSeatManagement },
      { path: 'reservations', component: AdminReservationManagement },
